...
?>
        ...
        <div class="row mt-3">
            ...
            <div class="col-md-6">
                <h1 class="text-center">Task 7: Simple Calculator</h1>
                <div class="card p-3">
                    ...
                    <form action="" method="post">
                        ...
                        <div class="text-center">
                            <input class="btn btn-primary my-3" type="submit" name="submit" value="Calculate" style="width:250px">
                        </div>
                        <div class="p-4 bg-light text-center">
                            <h3><?php if ( !empty( $result ) ) {echo "Result: <b class='text-success'>" . $result . "</b>";}?></h3>
                        </div>
                    </form>
